...
//\Cml\dd($this->requestType);
  ...
  public function doRequest() {
    ...
    if((null !== self::token) && self::token){
		// Client-Token:会自动被转换为: HTTP_CLIENT_TOKEN:
		$this->headers = array(
  ...
  private function setHeader(){
		...
		//curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json', 'Content-Length:' . strlen($this->data)));
  }
