...
//应用入口
use Cml\Cml;
define('CML_URL_DEFAULT_ACTION', 'bank/Index/index');//应用默认的action。不同的入口可自行更改
//定义项目根目录
...
//echo "apps_path:".Cml::getApplicationDir('apps_path')."<br>";
//注入服务并运行应用
...
Cml::runApp(function () {
	...
	Cml::getContainer()->singleton('cml_lock', \Cml\Lock\File::class);
	...
	//Cml::getContainer()->bind('db_oracle', \Cml\Db\Oracle\OracleDB::class);
