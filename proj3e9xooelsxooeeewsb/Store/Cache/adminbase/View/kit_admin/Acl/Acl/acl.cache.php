<?php if (!class_exists('\Cml\View')) die('Access Denied');?><link rel="stylesheet" href="<?php echo \Cml\Tools\StaticResource::parseResourceUrl("adminbase/kit_admin/plugins/ztree/zTreeStyle/zTreeStyle.css");?>"/>
...
<script src="<?php echo \Cml\Tools\StaticResource::parseResourceUrl("adminbase/kit_admin/plugins/ztree/jquery.ztree.all-3.5.min.js");?>"></script>
