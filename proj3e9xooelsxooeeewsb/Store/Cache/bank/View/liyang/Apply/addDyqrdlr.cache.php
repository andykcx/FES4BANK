...
<form class="layui-form" id="huozhuForm" action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
	  ...
	  <input type="text" name="dyqrbh" lay-verify="dyqrbh" value="<?php echo $apply['dyqrbh'];?>"  readonly autocomplete="off" class="layui-input layui-hide">
	...
	layer.alert('确认提交吗?', {
		...
		,yes:function(){
			$.ajax({
				type: 'POST',
				dataType:'json',
				url: '<?php \Cml\Http\Response::url("bank/Apply/ajaxDyqrdlr");?>',
				method:'post',
				data: {arrDlr:arrDlr},
