...
<form class="layui-form" id="huozhuForm" action="">
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
	  ...
	  <input type="text" name="dyrbh" lay-verify="dyrbh" value="<?php echo $apply['dyrbh'];?>"  readonly autocomplete="off" class="layui-input layui-hide">
	  <input type="text" name="dlrbh" lay-verify="dlrbh" value="<?php echo $apply['dlrbh'];?>"  readonly autocomplete="off" class="layui-input layui-hide">
    </div>
  </div>
  <div class="layui-form-item">
...
form.verify({
  ...
  console.log(data);
	...
	console.log('dyrdlr post arrDlr:');
	console.log(arrDlr);
	...
	layer.alert('确认提交吗?', {
		...
		,yes:function(){
			$.ajax({
				type: 'POST',
				dataType:'json',
				url: '<?php \Cml\Http\Response::url("bank/Apply/ajaxDyrdlr");?>',
				data: {arrDlr:arrDlr},
