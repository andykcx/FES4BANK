...
js;
    ...
    ->addFormItem('备注', 'remark', '请输入备注信息', '', '', FormBuildService::INPUT_EDITOR, 'adminbase/Public/upload')
    ...
    ->addFormItem('TEST', 'pic', 'TEST', '', '', FormBuildService::INPUT_IMAGE, 'adminbase/public/upload')
