...
use web\Model\System\LoginLogModel;
...
class PublicController extends Controller
{
    ...
    public function login()
    {
        ...
        $user && ResponseService::jsJump('web/Index/index');
    ...
    {
        Acl::logout();
        Response::redirect('web/public/login');
    }
    ...
    {
        $baseDir = Cml::getApplicationDir('apps_path') . "/web/Resource/liyang/plugins/ueditor/abcnimeinimei/";
	//\Cml\dd($baseDir);
