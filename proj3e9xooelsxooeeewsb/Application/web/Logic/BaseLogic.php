...
use web\Model\Acl\AppModel;
use web\Model\Acl\MenusModel;
use web\Model\System\SystemLogModel;
...
//\Cml\dd($url);
        ...
        } else if ($url == 'web/Index/index' && isset($_GET['app'])) {		
