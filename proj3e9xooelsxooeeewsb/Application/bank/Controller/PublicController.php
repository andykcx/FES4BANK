...
class PublicController extends Controller
{
    ...
    public function login()
    {
        ...
        //$user && ResponseService::jsJump('bank/Index/index');
		$user && ResponseService::jsJump('bank/Index/face');
    ...
    {
        $baseDir = Cml::getApplicationDir('apps_path') . "/bank/Resource/liyang/plugins/ueditor/abcnimeinimei/";
	//\Cml\dd($baseDir);
